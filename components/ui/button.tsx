...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-photohub-blue-primary text-white hover:bg-photohub-blue-dark",
        destructive: "bg-red-500 text-white hover:bg-red-600",
        outline: "border border-photohub-blue-primary text-photohub-blue-primary hover:bg-photohub-blue-light",
        secondary: "bg-gray-100 text-gray-900 hover:bg-gray-200",
        ghost: "hover:bg-gray-100 hover:text-gray-900",
        link: "text-photohub-blue-primary underline-offset-4 hover:underline",
      },
      size: {
