      ...
      },
      {
        ...
        headers: [
          ...
          // CSP - Content Security Policy
          {
            ...
            value: "default-src 'self'; img-src 'self' https: data: blob:; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; font-src 'self'; connect-src 'self' https://api.zippopotam.us https://login.microsoftonline.com; form-action 'self' https://login.microsoftonline.com; frame-ancestors 'none';",
          },
        ],
      },
    ]
